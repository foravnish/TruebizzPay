...
public class DtacardRechargeAsync extends AsyncTask<String, Void, String> {
    String dcsubscriberid, amount, operator_val,rech_type;
    Context context;
    ProgressDialog progressDialog;

    public DtacardRechargeAsync(Context context, final String dcsubscriberid, final String amount, final String operator_val,
                                final String rech_type) {
        this.context = context;
        this.dcsubscriberid = dcsubscriberid;
        this.amount = amount;
    ...
    protected String doInBackground(String... strings) {
        ...
        params.put("dcsubscriberid", dcsubscriberid);
        ...
        String result = jsonParser.makeHttpRequest(Api.Datacard_Recharge, "GET", params);
        return result;
    }
