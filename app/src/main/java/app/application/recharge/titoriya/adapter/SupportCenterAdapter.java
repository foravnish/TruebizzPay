...
public class SupportCenterAdapter extends PagerAdapter {
    private ArrayList<HashMap<String, String>> histItms;
    private Context mContext;
    private TextView action_val;
    private TextView trn_id_val,rchg_disID_val,sts_val,dis_date_val,dis_mgs_val,trn_id;
    ProgressDialog progressDialog;
    Dialog dialog;
    ListView listView;
    ArrayList<HashMap<String,String>> dist_list;
    public SupportCenterAdapter(Context activity, ArrayList<HashMap<String, String>> histItms) {
    ...
    public View instantiateItem(ViewGroup container, final int position) {
        ...
        rchg_disID_val.setText(histItms.get(position).get("ticket_id"));
        ...
        action_val.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getDisputeDetails(mContext, histItms.get(position).get("ticket_id"));
            }
        });
    ...
    private class RaiseDisputeAction extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            map.put("ticket_id",disputId);

            JSONParser jsonParser=new JSONParser();
            String result =jsonParser.makeHttpRequest(Api.ACTION_TICKET_UPDATE,"GET",map);
    ...
    private class RaiseDisputeActionDetails extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            map.put("user_token", MyPrefrences.getToken(context));
            map.put("agent_id", MyPrefrences.getUserId(context));
            map.put("ticket_id", dispute_id);


            JSONParser jsonParser=new JSONParser();
            String result =jsonParser.makeHttpRequest(Api.ACTION_DTICKET_DETAILS,"GET",map);
            ...
            try {
                ...
                if (jsonObject != null) {
                    if (jsonObject.optString("status").equalsIgnoreCase("1")) {
                        ...
                        listView.setAdapter(new SupportCenterDetailAdapter(context, dist_list));
